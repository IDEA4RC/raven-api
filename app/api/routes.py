...
api_router.include_router(
    health.router, prefix="/health", tags=["Health endpoint (health check)"]
)
...
# Workspace endpoints
api_router.include_router(
    workspace.router, prefix="/workspaces", tags=["Workspaces endpoint"]
)
...
api_router.include_router(
    cohort_result.router, prefix="/cohort-results", tags=["Cohort Results endpoint"]
)

# Analysis endpoints
api_router.include_router(
    analysis.router, prefix="/analyses", tags=["Analyses endpoint"]
)

# Workspace History endpoints
api_router.include_router(
    workspace_history.router,
    prefix="/workspace-history",
    tags=["Workspace History endpoint"],
)

api_router.include_router(
    data_preparation.router,
    prefix="/data-preparation",
    tags=["Data Preparation endpoint"],
)

api_router.include_router(
    metadata_search.router, prefix="/metadata", tags=["Metadata Search endpoint"]
)
